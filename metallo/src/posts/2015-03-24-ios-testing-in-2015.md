...
Some weeks ago I decided to focus my writing on [mokacoding](https://mokacoding.com) more on unit and acceptance testing, automation, and productivity, mainly in the iOS world.

This led to posts like [Setting up Calabash for iOS projects with CocoaPods and Build Configurations](https://mokacoding.com/blog/calabash-ios-with-cocoapods-and-build-configurations/) and [Running Xcode tests from the terminal](https://mokacoding.com/blog/running-tests-from-the-terminal/).
